...
function BusinessCard({ business }) {
  ...
  const tierBadgeStyles = {
    Gold: 'bg-tier-gold text-amber-900',
      ...
      <div className="mt-4 pt-4 border-t border-brand-gray-200">
        {contact?.phone && (
          <div className="flex items-center mb-2">
            ...
            <a href={`tel:${contact.phone}`} className="text-brand-gray-700 hover:text-brand-black transition-colors">{contact.phone}</a>
          </div>
        )}
        ...
        {contact?.email && (
          <div className="flex items-center mb-2">
            ...
            <a href={`mailto:${contact.email}`} className="text-brand-gray-700 hover:text-brand-black transition-colors">{contact.email}</a>
          </div>
        )}
        ...
        {contact?.website && (
          <div className="flex items-center">
            ...
            <a href={contact.website} target="_blank" rel="noopener noreferrer" className="text-brand-gray-700 hover:text-brand-black transition-colors truncate">
      ...
      <div className="premium-features mt-3">
        ...
        {contact?.website && (
          <a 
            ...
            className="inline-flex items-center mr-3 text-sm text-brand-gray-800 hover:text-brand-black transition-colors"
          >
        ...
        {contact?.whatsapp && (
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer" 
            className="inline-flex items-center text-sm text-brand-gray-800 hover:text-brand-black transition-colors"
          >
  ...
  return (
    <div className="rounded-lg overflow-hidden shadow-brand-md hover:shadow-brand-lg transition-all duration-300 border border-brand-gray-200">
      ...
      <div className="relative h-48 bg-brand-gray-200">
        ...
        {/* Category badge */}
        <div className="absolute bottom-2 left-2 px-2 py-1 rounded text-xs font-medium bg-brand-black text-white">
          {category}
        </div>
      </div>
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-2">
          ...
          {/* Rating */}
          <div className="flex items-center">
            <svg className="h-5 w-5 text-tier-gold" fill="currentColor" viewBox="0 0 20 20">
        ...
        <p className="text-brand-gray-700 line-clamp-2 mb-2">{description}</p>
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          {package_type === 'Gold' && (
            <span className="text-xs bg-tier-gold bg-opacity-20 text-amber-800 px-2 py-1 rounded font-medium">
              Featured
            </span>
          )}
        </div>
